...
namespace margelo::nitro::nitroinput::views {
  ...
  HybridNitroTextInputViewProps::HybridNitroTextInputViewProps(const react::PropsParserContext& context,
    ...
    onChangeText([&]() -> CachedProp<std::optional<std::function<void(const std::string& /* value */)>>> {
      try {
        ...
        const auto& [runtime, value] = (std::pair<jsi::Runtime*, jsi::Value>)*rawValue;
        return CachedProp<std::optional<std::function<void(const std::string& /* value */)>>>::fromRawValue(*runtime, value.asObject(*runtime).getProperty(*runtime, "f"), sourceProps.onChangeText);
      } catch (const std::exception& exc) {
        throw std::runtime_error(std::string("NitroTextInputView.onChangeText: ") + exc.what());
      }
    }()),
    value([&]() -> CachedProp<std::optional<std::string>> {
      try {
        ...
        throw std::runtime_error(std::string("NitroTextInputView.value: ") + exc.what());
      }
    }()),
