...
- (instancetype) init {
  if (self = [super init]) {
    std::shared_ptr<HybridNitroTextInputViewSpec> hybridView = NitroInput::NitroInputAutolinking::createNitroTextInputView();
...
- (void) updateView {
  // 1. Get Swift part
  NitroInput::HybridNitroTextInputViewSpec_cxx& swiftPart = _hybridView->getSwiftPart();
