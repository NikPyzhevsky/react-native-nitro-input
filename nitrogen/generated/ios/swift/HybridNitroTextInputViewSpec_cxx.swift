...
open class HybridNitroTextInputViewSpec_cxx {
  ...
  public final var onChangeText: bridge.std__optional_std__function_void_const_std__string_____value______ {
    @inline(__always)
    get {
    ...
    @inline(__always)
    set {
      self.__implementation.onChangeText = { () -> ((_ value: String) -> Void)? in
