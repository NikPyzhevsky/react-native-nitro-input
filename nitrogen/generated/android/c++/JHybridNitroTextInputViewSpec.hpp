...
namespace margelo::nitro::nitroinput {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitroinput/HybridNitroTextInputViewSpec;";
  ...
  public:
    ...
    std::optional<std::function<void(const std::string& /* value */)>> getOnChangeText() override;
    void setOnChangeText(const std::optional<std::function<void(const std::string& /* value */)>>& onChangeText) override;
