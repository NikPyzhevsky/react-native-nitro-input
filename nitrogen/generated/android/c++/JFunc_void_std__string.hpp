...
namespace margelo::nitro::nitroinput {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitroinput/Func_void_std__string;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitroinput/Func_void_std__string_cxx;";
